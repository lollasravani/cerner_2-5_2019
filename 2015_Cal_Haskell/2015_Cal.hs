...
month m startDay maxDay = show m ++ " 2015\n" ++ week ++ spaces Sunday
  where
    ...
    spaces currDay | startDay == currDay = days startDay 1 | otherwise           = "   " ++ spaces (next currDay)
